...
Then the employee is created and response contains key "Message" and value "Entry Created"
Then the employee ID "Employee[0].employee_id" is stored as a global variable to be used for other calls
...
|Prince              |null                       |Tetteh            |1999-07-11    |Male           |Cloud Architect|Employee|